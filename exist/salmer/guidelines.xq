       ...
       <div class="page-wrapper">
            <div class="background-box">
                <div class="headline-box container">
                    <h1>Vejledning til melodibasen</h1>
                </div>
            </div>
            <div class="container">
            ...
            <ul>
                ...
                <li><a href="#notation">Brug af noderne</a>
                    <ul>
                        ...
                        <li><a href="#midi">MIDI-download</a></li>
                        <li>
            ...
            <p>Databasen <em>Salmemelodier. Danske reformationssalmer 1529-1573</em> indeholder de melodier, der optræder i de danske salme- 
            og messebøger fra årene 1529-1573, som er udgivet digitalt på  
            ...
            Databasen illustrerer melodiernes indbyrdes forbindelser. Udover noderne indeholder basen kortfattede beskrivelser af melodiernes 
            tilblivelse og brug i reformationstiden. Yderligere information kan findes gennem referencer til relevant litteratur og links
            til andre digitale ressourcer.</p>
            ...
            <table>
                <tr>
                    <td><span class="relation music_document">En melodi i publikation</span></td>
                    <td>Melodi, som den står i en bestemt salme- eller messebog.<br/> 
                    Hvis melodien ikke forekommer i andre af korpussets bøger, findes eventuel historisk information om melodien også her.</td>
                </tr>
                <tr>             
                    <td><span class="relation melody">Melodi</span></td>
                    <td>Beskrivelse af en melodi, som optræder i flere af salmebøgerne. <br/>
                    Her findes den historiske information om melodien samt links til de poster, der beskriver melodien i de enkelte bøger. <br/>
                    De forskellige melodiforekomster gengives også, så de kan sammenlignes umiddelbart.</td>
                </tr>
                <tr>
                    <td><span class="relation publication">Publikation</span></td>
                    <td>Publikationsposterne repræsenterer de enkelte salme- og messebøger, som indeholder melodierne.<br/>
                    Posterne indeholder bl.a. sorterbare indholdsfortegnelser og kan derfor tjene som overblik over og indgang til bøgerne.</td>
                </tr>
                <tr>
                    <td><span class="relation liturgy">Liturgisk enhed</span></td>
                    <td>Beskriver en enhed, som typisk består af flere melodistykker og tekst, der ikke kan karakteriseres som 
            ...
            <p>Links til den digitale udgave af bøgerne er markeret med gult og indikerer med ikoner, om der er tale om en salmetekst med noder:
            ...
            <p><img style="float:right; margin: 0 0 20px 20px;" src="/style/img/menu.png" title="Nodemenu" alt="Nodemenu"/>Via menuknappen 
            <img src="/style/img/menu_icon.png" title="Menu" alt="Menu" width="26px"/> ud for hver melodi er 
            der mulighed for at interagere med noderne på forskellig vis:</p>
            
            <h3><a name="play">Afspilning</a></h3>
            <p>Klik på knappen <img src="/style/img/play.png" title="Afspilning" alt="Afspil"/> (afspil) for at lytte til melodien. 
            Noderne fremhæves under afspilningen.</p>
            
            <h3><a name="midi">MIDI-download</a></h3>
            <p>Melodierne kan downloades i MIDI-format, så de kan afspilles lokalt fra brugerens computer eller andre enheder.
            Klik på MIDI-ikonet <img src="/style/img/midi.svg" title="MIDI-download" alt="MIDI"/> i nodemenuen for at downloade MIDI-filen.<br/>
            Denne funktion er p.t. kun tilgængelig i melodibasen, ikke i den digitale udgave af bøgerne.</p>
            ...
            <p>I salme- og messebøgerne er melodierne noteret med ældre nodeformer: enten koralnotation (nodehoveder uden halse) eller mensuralnotation. 
            ...
            <p>På alle sider i melodibasen er der adgang til at søge i salmernes titler ved at klikke på søgeknappen 
            ...
            <p>På melodibasens søgeside er der desuden mulighed for at søge i selve melodierne. Søgesiden findes på <a href="mei_search.xq">https://salmer.dsl.dk/mei_search.xq</a>
            eller fra de øvrige sider ved at klikke på &quot;Avanceret søgning&quot; under titelsøgefeltet. Fanebladene giver adgang til en række forskellige søgefunktioner:</p>
            ...
            <ul>
                ...
                <li>Præcision: Der kan tillades op til to afvigelser fra den angivne søgestreng. 
                Som afvigelser tæller manglende toner, ekstra toner samt afvigende tonehøjder.</li>
            </ul>
            <p>EKSEMPEL: <a href="https://salmer.dsl.dk/mei_search.xq?a=77-77-77-72-76-77-74-72&amp;x=&amp;e=1&amp;f=2" title="Søg efter: Vor Gud han er så fast en borg">Søgning 
            efter de første otte toner af <em>Vor Gud han er 
            så fast en borg</em></a> efter den i dag kendte melodiversion kræver, at der tillades op til to afvigelser, da femte tone afviger (d i stedet for e) og der 
            er en ekstra gennemgangstone (mellem f og d) i den gamle melodiform.</p>
            ...
            direkte fra salmebøgerne eller noderne i salmebasen: Klik på en node og derefter en anden node for at markere et melodiudsnit. 
            Klik derefter på markeringen for at søge efter tilsvarende passager i alle melodierne.</p>
