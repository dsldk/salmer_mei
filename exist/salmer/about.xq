...
let $content := if (doc(concat("texts/about_",$language,".html")))
    then doc(concat("texts/about_",$language,".html"))
    else doc("texts/about_da.html")

let $output :=
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
	    <title>{$l/*[name()='page_title_about']/text()}</title>
        <meta charset="UTF-8"/>
